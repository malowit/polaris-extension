...
const PRICE_PATTERNS = {
  KZT: [
    /\b(\d[\d\s]{0,9}\d|\d+)\s*₸/g,
    /₸\s*(\d[\d\s]{0,9}\d|\d+)/g,
    /\b(\d[\d\s]{0,9}\d|\d+)\s*т(?:нг|г)\.?(?=[\s,.\u00A0]|$)/gi,
    /KZT\s*(\d[\d\s]{0,9}\d|\d+)/gi,
    /\b(\d[\d\s]{0,9}\d|\d+)\s*тенге\.?(?=[\s,!?.]|$)/gi,
    /\b(\d[\d\s]{0,9}\d|\d+)\s*tenge\.?(?=[\s,!?.]|$)/gi,
  ],
  USD: [
    /\$\s*(\d[\d,.]{0,11}\d|\d+)/g,
    /\b(\d[\d,.]{0,11}\d|\d+)\s*\$(?!\w)/g,
    /USD\s*(\d[\d,.]{0,11}\d|\d+)/gi,
    /\b(\d[\d,.]{0,11}\d|\d+)\s*dollars?\.?(?=[\s,!?.]|$)/gi,
  ],
  EUR: [
    /€\s*(\d[\d,.]{0,11}\d|\d+)/g,
    /\b(\d[\d,.]{0,11}\d|\d+)\s*€/g,
    /EUR\s*(\d[\d,.]{0,11}\d|\d+)/gi,
    /\b(\d[\d,.]{0,11}\d|\d+)\s*euros?\.?(?=[\s,!?.]|$)/gi,
  ],
  CNY: [
    /[¥￥]\s*(\d[\d,.]{0,9}\d|\d+)/g,
    /\b(\d[\d,.]{0,9}\d|\d+)\s*[¥￥](?!\w)/g,
    /CNY\s*(\d[\d,.]{0,9}\d|\d+)/gi,
    /元\s*(\d[\d,.]{0,9}\d|\d+)/g,
    /\b(\d[\d,.]{0,9}\d|\d+)\s*元/g,
    /\b(\d[\d,.]{0,9}\d|\d+)\s*yuan\.?(?=[\s,!?.]|$)/gi,
  ],
  VND: [
  ...
  THB: [
    /฿\s*(\d[\d,\s]{0,9}\d|\d+)/g,
    /\b(\d[\d,\s]{0,9}\d|\d+)\s*฿/g,
    /\b(\d[\d,\s]{0,9}\d|\d+)\s*(?:THB|baht)\.?(?=[\s,!?.]|$)/gi,
  ],
};
